...
os.system("python ~/FrankIA/visao/visao3.py&")
...
#read tragetory file
try:
	with open('/home/pi/FrankIA/tragetory/data_foot.txt', 'r') as f:
		data_foot = np.loadtxt('/home/pi/FrankIA/tragetory/data_foot.txt').reshape((nEstados,8))
		print ("File data_foot loaded!")
	with open('/home/pi/FrankIA/tragetory/data_pelv.txt', 'r') as f:
		data_pelv = np.loadtxt('/home/pi/FrankIA/tragetory/data_pelv.txt').reshape((nEstados,8))
