...
#CONFIGS +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
deslocamentoZpes = 3.2
deslocamentoXpes = 5.
deslocamentoYpes = 0.
deslocamentoYpelves = 1.6
...
pos_inicial_pelves = [3.2, 0., 14.2]
pos_inicial_pe = [3.2, 0., 14.2]
...
def thread_cinematica_pe(indice):
	...
	pos[2] = 14.2 - deslocamentoZpes*np.exp(-((indice-nEstados/2)**2)/600)
